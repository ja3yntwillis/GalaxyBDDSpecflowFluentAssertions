...
{
    public class AZStorageRESTResultsLogger : ILogResults
    {
        ...
        public TestDto EndTest(string runId, string testId, string status, int attempts, string testData, ErrorDto errorDto, ActionDto actionDto, DateTime endTime)
        {
            ...
            {
                PutBlob(runId, $"{testId}_testData", testData, RunnerConfiguration.AZStorageTestDataBlobContainer);
            }
        ...
        public string StartTest(string runId, string testId, string assmebly, string fixture, string method, DateTime startTime, string labels)
        {
            if (testId == null)
            {
                testId = GetTestId();
        ...
        public bool SaveLoadTestRow(Dictionary<string, string> rowDictionary)
        {
            try
            {
                Call(HttpMethod.Post, "", rowDictionary, "loadTestResults", ref placeHolder);
                return true;
            }
            catch
            {
